...
_EXTERNAL_TOOL_MODULE_NAMESPACE = "reachy_imposter_app._external_tools"
...
def _load_enabled_tools(tool_names: list[str], remote_tool_names: set[str]) -> List[type[Tool]]:
    ...
    for tool_name in tool_names:
        ...
        shared_module_path = f"reachy_imposter_app.tools.{tool_name}"
        try:
