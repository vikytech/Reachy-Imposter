...
import reachy_imposter_app.prompts as prompts_mod
import reachy_imposter_app.personality as headless_mod
import reachy_imposter_app.profile_store as profile_store_mod
from reachy_imposter_app.config import DEFAULT_PROFILES_DIRECTORY, config
from reachy_imposter_app.personality import (
    list_personalities,
)
from reachy_imposter_app.profile_store import read_profile, write_profile, read_profile_from_directory
...
#     \spaces--pollen-robotics--reachy_imposter_app
...
#   back to the budget: 101 + len("reachy_imposter_app\") (29) = 130.
#
...
def test_explicit_default_profile_does_not_fall_back_to_itself(
    ...
    with caplog.at_level(logging.WARNING, logger="reachy_imposter_app.prompts"):
