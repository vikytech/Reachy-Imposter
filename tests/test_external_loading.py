...
def _reload_core_tools() -> ModuleType:
    ...
    for module_name in list(sys.modules):
        if module_name.startswith(("reachy_imposter_app.tools.", "reachy_imposter_app._external_tools.")):
            sys.modules.pop(module_name, None)

    sys.modules.pop("reachy_imposter_app.tools.core_tools", None)
    core_tools_mod = importlib.import_module("reachy_imposter_app.tools.core_tools")
...
def test_external_tools_can_be_loaded_without_external_profile(
    ...
    assert "reachy_imposter_app._external_tools.json" in sys.modules
