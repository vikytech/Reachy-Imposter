...
import reachy_imposter_app.personality as personality_mod
from reachy_imposter_app.config import config
from reachy_imposter_app.avatars import (
    DEFAULT_AVATAR_FILE,
    avatar_id_for,
    read_avatar_svg,
)
from reachy_imposter_app.personality import save_user_personality
...
def test_avatar_unavailable_raises(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "reachy_imposter_app.personality_routes.read_avatar_svg",
        lambda name: None,
    )
